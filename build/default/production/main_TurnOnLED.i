...
# 12 "./config.h" 2
# 1 "./globalDefinitions.h" 1
# 13 "./config.h" 2

void configPIC(void);
# 36 "main_TurnOnLED.c" 2
...
void initLCD(){
 ...
 LATBbits.LB4 = 0;
    ...
    _delay((unsigned long)((4167)*(48000000/4000000.0)));
 ...
 _delay((unsigned long)((833)*(48000000/4000000.0)));
...
void LCDmarkerP1(){
    _delay((unsigned long)((40)*(48000000/4000000.0))); writeCommand(0x80);
    for(int j=0;j<3;j++){
    _delay((unsigned long)((40)*(48000000/4000000.0))); writeCommand(0x14);
    }
    sprintf(P1buffer,"%d",P1points);
    _delay((unsigned long)((40)*(48000000/4000000.0))); dataToLCD(P1buffer);
}
...
void LCDmarkerP1Space(){
    ...
    _delay((unsigned long)((2)*(48000000/4000.0))); writeData(' ');
...
void LCDmarkerP2(){
    ...
    _delay((unsigned long)((40)*(48000000/4000000.0))); dataToLCD(P2buffer);
}
...
void LCDmarkerP3(){
    ...
    _delay((unsigned long)((40)*(48000000/4000000.0))); dataToLCD(P3buffer);
}
...
void LCDmarkerP4(){
    ...
    _delay((unsigned long)((40)*(48000000/4000000.0))); dataToLCD(P4buffer);
}

void LCD_Vel(){
    _delay((unsigned long)((40)*(48000000/4000000.0))); writeCommand(0xC0);
    for(int j=0;j<4;j++){
    _delay((unsigned long)((40)*(48000000/4000000.0))); writeCommand(0x14);
    }
   sprintf(VelBuffer,"%d",velocity);
   _delay((unsigned long)((40)*(48000000/4000000.0))); dataToLCD(VelBuffer);
}
...
void LCD_time(){
   ...
   _delay((unsigned long)((40)*(48000000/4000000.0))); dataToLCD(TimeBuffer);
}
...
void printBoost(){
   ...
   _delay((unsigned long)((40)*(48000000/4000000.0))); dataToLCD("BOOST");
}
...
void clearBoost(){
   ...
   _delay((unsigned long)((40)*(48000000/4000000.0))); dataToLCD("     ");
}

void gameInit(){
    unsigned char celebration[]="Welcome!";
    dataToLCD(celebration);
    _delay((unsigned long)((2000)*(48000000/4000.0))); writeCommand(0b00000001);
    _delay((unsigned long)((2)*(48000000/4000.0))); writeCommand(0b00111000);
    _delay((unsigned long)((2)*(48000000/4000.0))); writeCommand(0xC);
}

void celebrationP1(){
    _delay((unsigned long)((100)*(48000000/4000.0))); writeCommand(0b00000001);
...
void __attribute__((picinterrupt(""))) isrPlayer1(void){
   if(INT0IF==1){
    ...
    while (1){
        ...
        if (P1points>4){
            ...
            for (int ii=0;ii<3;ii++){
                _delay((unsigned long)((2)*(48000000/4000.0))); writeCommand(0b00000001);
                wait_in_ms(250);
                PrintDisplay();
                wait_in_ms(250);
                _delay((unsigned long)((2)*(48000000/4000.0))); writeCommand(0b00000001);
